...
public class AuthenticationFilter extends AbstractGatewayFilterFactory<AuthenticationFilter.Config> {
    ...
    public AuthenticationFilter(JwtUtil jwtUtil, RestTemplate restTemplate, RouteValidator routeValidator) {
        super(Config.class);
            ...
            if (validator.isSecure.test((ServerHttpRequest) exchange.getRequest())) {
                ...
                !exchange.getRequest().getCookies().containsKey("refresh")) {
                    ...
                    StringBuilder stringBuilder = new StringBuilder("{\n")
                            ...
                            .append("\"message\": \"Token is null or expired\", \n")
                            .append("\"code\": BAD_TOKEN\"\n")
                            .append("}");
                ...
                try {
                    if (activeProfile.equals("test")) {
                        ...
                        ResponseEntity<String> response = template.exchange(
                                "http://localhost:8080/api/v1/auth/validate", HttpMethod.GET, entity, String.class);
